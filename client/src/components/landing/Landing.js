                ...
                <div className="col s12">
                  <article>
                    ...
                    <p className="flow-text">
                      I'm a developer / data analyst based in Irvine,
                      California. I have a passion for building full stack web
                      applications and a goal to always be learning.
                    </p>
                  </article>
                </div>
              </div>
                    ...
                    <div id="data" className="row">
                      ...
                      <div className="col s12 l7">
                        <div className="details">
                          ...
                          <p className="flow-text">
                            From ideation to deployment, my goals are to focus
                            on building intuitive content that streamlines
                            processes.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="col s12 l7 pull-l5">
                        <div className="details">
                          ...
                          <p className="flow-text">
                            ...
                            analytics. I'm driven to learn and adapt as
                            technology changes.
                          </p>
                        </div>
                      </div>
