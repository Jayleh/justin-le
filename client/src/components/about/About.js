...
const About = () => {
  const renderAccentSpan = text => {
    return <span className="color-accent">{text}</span>;
  };

  const renderDates = (fromDate, toDate) => {
    return (
      <React.Fragment>
        {fromDate} - {renderAccentSpan(toDate)}
      </React.Fragment>
    );
  };

  const renderWebLink = (link, name) => {
    return (
      <a
        href={link}
        target="_blank"
    ...
    <React.Fragment>
      <div id="about" className="container">
        ...
        <div className="row">
          <div className="col s12">
            <p>
              <span className="text-important">Developer</span>, specializing in
              operations, sales analytics, and inventory management. Able to{' '}
              <span className="text-important">solve business needs</span> with
              quick deliverables, while{' '}
              <span className="text-important">constantly improving</span> and
              moving towards{' '}
              <span className="text-important">long-term goals</span>. Looking
              to build{' '}
              <span className="text-important">robust applications</span> with a{' '}
              <span className="text-important">fast-paced</span> and growing
              company.
            </p>
          </div>
        </div>
      ...
      <div id="experience" className="container">
        ...
        <section>
          <CardExperience
            location="Irvine, CA"
            dates={renderDates("Dec'17", 'today')}
            imageSrc={turtle}
            imageAlt="turtle"
            title="Developer &#124; Data Analyst &#124; Inventory Specialist"
            subTitle={renderWebLink('https://anteage.com/', 'Cellese')}
          ...
          <CardExperience
            ...
            subTitle={renderWebLink('http://www.epik.go.kr/index.do', 'EPIK')}
            description="English Program in Korea to help improve English-speaking
                    ...
                    things this new age of information and globalization has to
                    offer."
      ...
      <div id="education" className="container">
        ...
        <section>
          ...
          <CardExperience
            ...
            subTitle={renderWebLink('https://www.calpoly.edu/', 'Cal Poly SLO')}
          ...
          <div className="row">
            <div className="col s12 m6 xl12">
              <div className="bootcamp-image valign-wrapper">
                <img src={bootcamp} className="responsive-img" alt="bootcamp" />
              </div>
              <div className="bootcamp-image valign-wrapper">
                <img
                  src={certificate}
